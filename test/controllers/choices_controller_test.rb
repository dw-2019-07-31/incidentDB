...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { column_name: @choice.column_name, value: @choice.value } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { column_name: @choice.column_name, value: @choice.value } }
